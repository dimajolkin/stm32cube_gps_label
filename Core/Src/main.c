...
int main(void)
{
 ...
 _lcd = ili9341_new(
  ...
  while (1)
  {
    ...
    // ili9341_fill_screen(_lcd, ILI9341_WHITE);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TFT_DC_Pin|TFT_RESET_Pin|TFT_CS_Pin, GPIO_PIN_RESET);
